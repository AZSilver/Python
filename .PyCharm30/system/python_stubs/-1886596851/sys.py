...
executable = 'C:\\test.env\\Scripts\\python.exe'

exec_prefix = 'C:\\test.env'
...
path = [
    'C:\\Program Files (x86)\\JetBrains\\PyCharm Community Edition 3.4.1\\helpers',
    'C:\\Windows\\system32\\python27.zip',
    'C:\\test.env\\DLLs',
    'C:\\test.env\\lib',
    'C:\\test.env\\lib\\plat-win',
    'C:\\test.env\\lib\\lib-tk',
    'C:\\test.env\\Scripts',
    'C:\\Python27\\Lib',
    'C:\\Python27\\DLLs',
    'C:\\Python27\\Lib\\lib-tk',
    'C:\\test.env',
    'C:\\test.env\\lib\\site-packages',
]
